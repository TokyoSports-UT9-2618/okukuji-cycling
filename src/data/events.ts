...
export const events: EventData[] = [
  ...
  // ============================
  {
    ...
    heroTagline:
      '自然とスピードの調和。奥久慈の渓谷を駆け抜けるプレミアムライド。',
    ...
    schedule: [
      {
        ...
        title: '受付開始',
        description:
          'JR常陸大子駅前広場で受付。ゼッケン配布と最終ブリーフィング。',
      },
      {
        time: '08:30',
        title: 'スタート',
      ...
      },
      {
        ...
        title: 'ゴール＆交流会',
        description:
          '完走証授与、地元食材のBBQ交流会。仲間との時間を楽しもう。',
      },
    ],
    ctaTitle: '走る準備は\nできた？',
    ctaText:
      '2026年秋の奥久慈ライド、定員に達し次第締め切り。今すぐエントリーを。',
    ctaButtonLabel: 'エントリーする',
    ctaButtonUrl: '#',
    mapEmbedUrl:
      'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d102400!2d140.35!3d36.77!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60218c0a5b8b1c5d%3A0x4e3e5f6a7b8c9d0e!2z5aWl5LmF5oWI!5e0!3m2!1sja!2sjp!4v1',
    status: 'upcoming',
  },
];
